...
const Registration = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (userInput.role === "hoter-owner" && !userInput.phone.trim()){
            return setUserInput({errorMessage: "Hoter Owner phone is required"})
        }
        ...
        <div className="container !mt-40">
            <div className="max-w-lg mx-auto card p-5 ">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {userInput.role === "hoter-owner" && <InputGroup
                        name="phone"
                        onChange={handleChange}
                        labelClass="font-sm  text-gray-600"
                        className="flex flex-col mt-4"
